...
import { X, Copy, Check, Mail, Play } from "lucide-react";
...
interface ShareModalProps {
  ...
  runStatus?: "PASSED" | "FAILED" | "PENDING" | "RUNNING" | "CANCELLED" | null;
  onRunTest?: () => void;
}
...
const ShareModal = ({
  ...
  // No test run yet - show prompt to run test first
  const noShareLink = !shareToken;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <h2 className="text-lg font-semibold text-[#1f2937]">Share Test Results</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          {noShareLink ? (
            // No test run - prompt to run test
            <div className="text-center py-4">
              <div className="size-16 mx-auto mb-4 rounded-full bg-[#f4f4f5] flex items-center justify-center">
                <Play className="size-8 text-[#667085]" />
              </div>
              <h3 className="text-base font-medium text-[#1f2937] mb-2">
                Run the test first
              </h3>
              <p className="text-sm text-[#667085] mb-6">
                Run the test to generate a shareable link with results, screenshots, and errors.
              </p>
              {onRunTest && (
                <button
                  onClick={() => {
            ...
            <>
              ...
              {runStatus && (
                <div className="flex items-center justify-center">
                  ...
                  >
                    {runStatus === "PASSED" && "✓ Test Passed"}
                    {runStatus === "FAILED" && "✗ Test Failed"}
